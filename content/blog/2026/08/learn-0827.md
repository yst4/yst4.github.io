...
これをmainのところに加えて、runを５つ同時に動かすようにした。シングルだけでやってる時より格段に時間が短くなって、この方法知ってないと色んな試行するのに差が出るんやろなぁ。と思ったな。そのくらい差がてきめんに違ったですね。この本でjoblib.Parallelをどこらへんから活用してるのか走らないんですが。
