...
<!-- more -->
## Rのプロジェクト管理はない
意外とないんだね。というのが感想。Rstudioにはプロジェクトを作るのはあるようなんですが、私の環境はRstudio使ってないのでね。基本的にZED, nvimとradianという構成にしてて、jupyterでも利用できるようにしていますね。ここではRをZEDやnvimで使いやすくするlspの設定は軽くしか振れないつもりですが。基本的にCLIでしターミナルを使ってシェルスクリプトを動かしてプロジェクトを作っちゃいましょうってやってます。
